...
time ./bmps -w 720 -h 600 -s 512 -d 10 -t 31 -i path -r 0.15 -o "../image/bmps_015.ppm"
time ./bmps -w 720 -h 600 -s 512 -d 10 -t 31 -i path -r 0.35 -o "../image/bmps_035.ppm"
time ./bmps -w 720 -h 600 -s 512 -d 10 -t 31 -i path -r 0.55 -o "../image/bmps_055.ppm"
time ./bmps -w 720 -h 600 -s 512 -d 10 -t 31 -i path -r 0.75 -o "../image/bmps_075.ppm"
...
time ./street -w 800 -h 800 -s 512 -d 10 -t 31 -i path
